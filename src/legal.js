/** Pravne informacije in vsebina strani – Strelko / Meteoinfo d.o.o. */
...
export function resolveLegalPageId(pathname) {
  const path = (pathname || "/").replace(/\/$/, "") || "/";
  return Object.entries(LEGAL_PAGES).find(([, page]) => page.path === path)?.[0] || null;
}
